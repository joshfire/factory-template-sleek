...
define('joshfire-framework/adapters/phone/utils/onready',[],function() {
...
define('joshfire-framework/ui/fadeinpanel',[
...
define('tpl!templates/phone/contactIndex.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">', textContent ,'</div>');}return __p.join('');}});

define('tpl!templates/phone/contactMap.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="google-map"></div>');}return __p.join('');}});

define('tpl!templates/phone/event.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  '); if (item.startDate && item.endDate && (item.startDate !== item.endDate)) { ; __p.push('  <h3><span>From ', moment(toDate(item.startDate)).format('LLLL') ,' to ', moment(toDate(item.endDate)).format('LLLL') ,'</span></h3>  '); } else if (item.startDate) { ; __p.push('    <h3><span>On ', moment(toDate(item.startDate)).format('LLLL') ,'</span></h3>  '); } ; __p.push('  <h4>', item.name ,'</h4>  '); if(item.description) { ; __p.push('    <p class="description">', item.description ,'</p>  '); } ; __p.push('  '); if(item.location && item.location.name) { ; __p.push('    <p class="location">', item.location.name ,'</p>  '); } ; __p.push('</div>');}return __p.join('');}});

define('tpl!templates/phone/eventItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (item.startDate) { ; __p.push('      <h3>        <span>', moment(toDate(item.startDate)).calendar() ,'</span>      </h3>      '); } ; __p.push('      <h4>', item.name || item.description ,'</h4>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/desktop/listView.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="first">  <ul class="list">    ', children ,'  </ul></div><div class="loader large">&nbsp;</div>');}return __p.join('');}});

define('tpl!templates/phone/mapOverlay.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class="map-overlay">', address ,'</p>');}return __p.join('');}});

define('tpl!templates/phone/mentionItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(''); if( item.image ) { ; __p.push('   <img data-joshfire-autothumb="true"/>'); } ; __p.push(''); if( item.contentURL ) { ; __p.push('  <img data-joshfire-autothumb="true"/>'); } ; __p.push(''); if( item.datePublished) { ; __p.push('  <h3>',  moment(toDate(item.datePublished)).format('LLLL') ,'</h3>'); } ; __p.push(''); if( item.name && item["@type"] !== "ImageObject") { ; __p.push('  <h4>', item.name ,'</h4>'); } ; __p.push(''); if( item.description ) { ; __p.push('  <div class="article">    ', item.description ,'  </div>'); } ; __p.push(''); if( item.author ) { ; __p.push('  <span>', item.author.name ,'</span>'); } ; __p.push('');}return __p.join('');}});

define('tpl!templates/phone/news.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('  <h3>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).format('LLLL') ,'</h3>  '); } ; __p.push('  <h4>', item.name ,'</h4>  <div class="article">  '); if (item.articleBody) { ; __p.push('  ', item.articleBody ,'  '); } else if (item.description) { ; __p.push('  ', item.description ,'  '); } ; __p.push('  </div></div>');}return __p.join('');}});

define('tpl!templates/phone/newsItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (imageUrl) { ; __p.push('        <div class="figure">          <div class="img fadein" data-joshfire-autothumb="true"></div>          <div class="loader inv"></div>        </div>      '); } ; __p.push('      '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('      <h3>        <span>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).fromNow() ,'</span>      </h3>      '); } ; __p.push('      <h4>', item.name || item.description ,'</h4>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/phone/other.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  <h4>', item.name ,'</h4>  '); if (imageUrl) { ; __p.push('    <div class="center"><img src="', imageUrl ,'" alt="" /></div>  '); } ; __p.push('  <div class="article">  '); if (item.articleBody) { ; __p.push('  ', item.articleBody ,'  '); } else if (item.description) { ; __p.push('  ', item.description ,'  '); } ; __p.push('  </div></div>');}return __p.join('');}});

define('tpl!templates/phone/otherItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      <h4>', item.name || item.description ,'</h4>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/phone/photo.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  <h4>', item.name ,'</h4>  '); if (imageUrl) { ; __p.push('    <div class="center"><img src="', imageUrl ,'" alt="" /></div>  '); } ; __p.push('  <div class="article">  '); if (item.articleBody) { ; __p.push('  ', item.articleBody ,'  '); } else if (item.description) { ; __p.push('  ', item.description ,'  '); } ; __p.push('  </div></div>');}return __p.join('');}});

define('tpl!templates/desktop/photoItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="figure">  <a class="img fadein" href="', item.contentURL ,'" title="', item.name ,'" style="background-image: url(', imageUrl ,')">&nbsp;</a></div>');}return __p.join('');}});

define('tpl!templates/phone/product.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  <h4>', item.name ,'</h4>  '); if (imageUrl) { ; __p.push('    <div class="center"><img src="', thumbnail(120,90) ,'" alt="" /></div>  '); } ; __p.push('  <div class="article">  '); if (item.articleBody) { ; __p.push('  ', item.articleBody ,'  '); } else if (item.description) { ; __p.push('  ', item.description ,'  '); } ; __p.push('  </div>  '); if (item.offers && item.offers[0] && item.offers[0].price) { ; __p.push('  <div class="offer">Price: ', (item.offers[0].priceCurrency === 'EUR') ? '€' : ((item.offers[0].priceCurrency === 'GBP') ? '₤' : '$') ,'', item.offers[0].price ,'</div>  '); } ; __p.push('</div>');}return __p.join('');}});

define('tpl!templates/desktop/productItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      <h4>        ', item.name ,'        '); if (item.offers && item.offers[0] && item.offers[0].price) {  ; __p.push('          <span class="offer">', (item.offers[0].priceCurrency === 'EUR') ? '€' : ((item.offers[0].priceCurrency === 'GBP') ? '₤' : '$') ,'', item.offers[0].price ,'</span>        '); } ; __p.push('      </h4>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/phone/singlePhoto.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="first">  <ul class="list">    ', children ,'  </ul>  <div class="meta">    <div class="cell">      '); if(collection.at(0)) { ; __p.push('      ', collection.at(0).get('name') ,'      '); } ; __p.push('    </div>  </div></div><div class="loader large">&nbsp;</div>');}return __p.join('');}});

define('tpl!templates/desktop/sound.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('  <h3>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).format('LLLL') ,'</h3>  '); } ; __p.push('  <h4>    ', item.name ,'    '); if (item.byArtist && item.byArtist.name) { ; __p.push(' by ', item.byArtist.name ,'    '); } else if (item.author && item.author.name) { ; __p.push(' by ', item.author.name ,''); } ; __p.push('  </h4>  '); if(item.thumbnail && item.thumbnail.length) { ; __p.push('    <img src="', item.thumbnail[0].contentURL ,'" />  '); } ; __p.push('  <div class="media">', media.html ,'</div>  '); if(item.description) { ; __p.push('  <p>', item.description ,'</p>  '); } ; __p.push('</div>');}return __p.join('');}});

define('tpl!templates/phone/soundItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (item.byArtist && item.byArtist.name) { ; __p.push('        <h3>', item.byArtist.name ,'</h3>      '); } else if (item.author && item.author.name) { ; __p.push('        <h3>', item.author.name ,'</h3>      '); } ; __p.push('      <h4>', item.name ,'</h4>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/phone/status.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  <div class="header">    '); if (imageUrl) { ; __p.push('      <img src="', thumbnail(48,48) ,'" alt="" />    '); } ; __p.push('    '); if (item.author && item.author[0] && item.author[0].name) { ; __p.push('      <h2>', item.author[0].name ,'</h2>    '); } ; __p.push('    '); if (item.author && item.author[0] && item.author[0]['foaf:nick']) { ; __p.push('      <h3>@', item.author[0]['foaf:nick'] ,'</h3>    '); } ; __p.push('  </div>  <div class="arrow"><span>&nbsp;</span></div>  <div class="message">    <div class="cover">&nbsp;</div>    '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('    <h4>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).fromNow() ,'</h4>    '); } ; __p.push('    <p>', prettyStatus(item.name) ,'</p>  </div>  <div class="attached-medias"></div></div>');}return __p.join('');}});

define('tpl!templates/desktop/statusItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    '); if (imageUrl) { ; __p.push('      <div class="figure">        <div class="img fadein" title="', (item.author && item.author[0] ? item.author[0].name : '') ,'" style="background-image: url(', imageUrl ,')"></div>        <div class="loader"></div>      </div>    '); } ; __p.push('    <div class="right">      '); if (item.author && item.author[0] && item.author[0].name) { ; __p.push('      <h3>        ', item.author[0].name ,'        '); if (item.author[0]['foaf:nick']) { ; __p.push('          @', item.author[0]['foaf:nick'] ,'        '); } ; __p.push('      </h3>      '); } ; __p.push('      <p>', item.name ,'</p>      '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('        <h4>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).fromNow() ,'</h4>      '); } ; __p.push('    </div>  </a>  <div class="attached-medias"></div></div>');}return __p.join('');}});

define('tpl!templates/phone/toolbar.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul>  ', children ,'</ul>');}return __p.join('');}});

define('tpl!templates/phone/toolbarItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="', item.linkURL ,'" class="', (item.name.toLowerCase() === 'contact') ? 'contact' : item.icon ,' section-', item.slug ,'">  <div class="indicator"><span>&nbsp;</span></div>  ', item.name ,'<span>&nbsp;</span></a>');}return __p.join('');}});

define('tpl!templates/desktop/video.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="media" style="height:', media.metadata.height ,'px">  ', media.html ,'</div><div class="body">  <div class="wrapper" style="height:', height - media.metadata.height ,'px;position:relative">    <div>      '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('      <h3>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).format('LLLL') ,'</h3>      '); } ; __p.push('      <h4>', item.name ,'</h4>      <div class="article">      '); if(item.description) { ; __p.push('      <p>', item.description ,'</p>      '); } ; __p.push('      </div>    </div>  </div></div>');}return __p.join('');}});

define('tpl!templates/desktop/videoItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (imageUrl) { ; __p.push('        <div class="figure">          <div class="img fadein" style="background-image: url(', imageUrl ,')"></div>          <div class="loader inv"></div>        </div>      '); } ; __p.push('      <div class="right">        <h3>', item.name ,'</h3>      </div>    </div>  </a></div>');}return __p.join('');}});

define('tpl!templates/desktop/detailView.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div></div><div class="spinner">&nbsp;</div>');}return __p.join('');}});

define('tpl!templates/desktop/itemList.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="list">  ', children ,'</ul>');}return __p.join('');}});
