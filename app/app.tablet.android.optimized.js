...
define('tpl!templates/tablet/listView.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="first">  <ul class="list">    ', children ,'  </ul></div><div class="loader large">&nbsp;</div>');}return __p.join('');}});
...
define('tpl!templates/tablet/photoItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="figure">  <a class="img fadein" title="', item.name ,'" data-joshfire-autothumb="true">&nbsp;</a></div>');}return __p.join('');}});
