...
(function() {
  ...
  */
  JF = {
    ...
    * @type {Object}
    */
    adapterModules: {"android":["app","inputs/touch","uielements/list","uielements/panel","uielements/video.mediaelement","utils/datasource"],"browser":["app","inputs/http","inputs/keyboard","inputs/mouse","uielement","uielements/list","uielements/mediacontrols","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","uielements/video.popup","uielements/video.youtube.swf","utils/activitymonitor","utils/datasource","utils/localstorage","utils/navigation","utils/stresstest"],"googletv":["inputs/keyboard"],"ios":["dependencies.json"],"node":["app.factory","app","class","global.exec","inputs/http","uielement","uielements/page","uielements/panel","uielements/panel.manager","uielements/video.mediaelement","utils/datasource","utils/eventsocket","utils/templatecompiler.cli","utils/templatecompiler","vendor/json2"],"none":[],"philips":["app","inputs/remote","uielement","uielements/list","uielements/video.mediaelement","utils/datasource","utils/stresstest"],"phone":["collection","uielement","utils/onready"],"qt4":[],"samsungtv":["app","inputs/remote","uielements/map","uielements/video.mediaelement","utils/navigationhelper"]},
  ...
  if (typeof this.Joshfire == "undefined") {
    this.Joshfire = {};
  }
  ...
  if (require.config) {
    require.config({
      ...
      urlArgs: (this.Joshfire.debug?"bust=" +(new Date()).getTime():"")
    });
  }
