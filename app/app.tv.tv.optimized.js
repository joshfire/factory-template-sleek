...
define('joshfire-framework/adapters/tv/utils/onready',[],function() {
...
define('joshfire-framework/adapters/tv/utils/dollar',["joshlib!vendor/jquery"],function($) {
  return $;
});
