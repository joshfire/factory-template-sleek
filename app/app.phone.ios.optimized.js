...
define('joshfire-framework/ui/slidepanel',["joshlib!ui/cardpanel","joshlib!vendor/underscore","joshlib!utils/dollar"], function(UICardPanel,_,$) {
...
define('joshfire-framework/adapters/phone/ui/toolbar',[
  'joshlib!ui/list',
  'joshlib!utils/dollar',
  'require',
  'joshlib!vendor/underscore'
...
define('tpl!templates/phone/listView.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="first">  <ul class="list">    '); if (typeof children != "undefined" && children.length == 0) {; __p.push('      <li class="no-data">', T("No data") ,'</li>    ');} ; __p.push('    ', children ,'  </ul></div><div class="loader large">&nbsp;</div>');}return __p.join('');}});
...
define('tpl!templates/phone/photoItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="figure">  <a class="img fadein" data-joshfire-autothumb="true" href="', item.contentURL ,'" title="', item.name ,'">&nbsp;</a></div>');}return __p.join('');}});
...
define('tpl!templates/phone/productItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (imageUrl) { ; __p.push('        <div class="figure">          <div class="img fadein" data-joshfire-autothumb="true"></div>          <div class="loader"></div>        </div>      '); } ; __p.push('      <h4>        ', item.name ,'        '); if (item.offers && item.offers[0] && item.offers[0].price) {  ; __p.push('          <span class="offer">', (item.offers[0].priceCurrency === 'EUR') ? '€' : ((item.offers[0].priceCurrency === 'GBP') ? '₤' : '$') ,'', item.offers[0].price ,'</span>        '); } ; __p.push('      </h4>    </div>  </a></div>');}return __p.join('');}});
...
define('tpl!templates/phone/sound.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="body">  '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('  <h3>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).format('LLLL') ,'</h3>  '); } ; __p.push('  <h4>    ', item.name ,'    '); if (item.byArtist && item.byArtist.name) { ; __p.push(' by ', item.byArtist.name ,'    '); } else if (item.author && item.author.name) { ; __p.push(' by ', item.author.name ,''); } ; __p.push('  </h4>  '); if(imageUrl) { ; __p.push('    <img data-joshfire-autothumb="true" />  '); } ; __p.push('  <div class="media">', media.html ,'</div>  '); if(item.description) { ; __p.push('  <p>', item.description ,'</p>  '); } ; __p.push('</div>');}return __p.join('');}});
...
define('tpl!templates/phone/statusItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    '); if (imageUrl) { ; __p.push('      <div class="figure">        <div class="img fadein" title="', (item.author && item.author[0] ? item.author[0].name : '') ,'" data-joshfire-autothumb="true"></div>        <div class="loader"></div>      </div>    '); } ; __p.push('    <div class="right">      '); if (item.author && item.author[0] && item.author[0].name) { ; __p.push('      <h3>        ', item.author[0].name ,'        '); if (item.author[0]['foaf:nick']) { ; __p.push('          @', item.author[0]['foaf:nick'] ,'        '); } ; __p.push('      </h3>      '); } ; __p.push('      <p>', item.name ,'</p>      '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('        <h4>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).fromNow() ,'</h4>      '); } ; __p.push('    </div>  </a></div>');}return __p.join('');}});
...
define('tpl!templates/phone/video.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="media" style="height:', media.metadata.height ,'px">  ', media.html ,'</div><div class="body">  <div class="wrapper">    <div>      '); if (item.datePublished || item.uploadDate || item.dateCreated) { ; __p.push('      <h3>', moment(toDate(item.datePublished || item.uploadDate || item.dateCreated)).format('LLLL') ,'</h3>      '); } ; __p.push('      <h4>', item.name ,'</h4>      <div class="article">        '); if (item.articleBody) { ; __p.push('        ', item.articleBody ,'        '); } else if (item.description) { ; __p.push('        ', item.description ,'        '); } ; __p.push('      </div>    </div>  </div></div>');}return __p.join('');}});

define('tpl!templates/phone/videoItem.ejs', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>  <a href="#', section.slug ,'/', offset ,'">    <div>      '); if (imageUrl) { ; __p.push('        <div class="figure">          <div class="img fadein" data-joshfire-autothumb="true"></div>          <div class="loader inv"></div>        </div>      '); } ; __p.push('      <div class="right">        <h3>', item.name ,'</h3>      </div>    </div>  </a></div>');}return __p.join('');}});
