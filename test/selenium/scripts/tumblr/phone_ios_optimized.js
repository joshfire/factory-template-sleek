...
/**
 * @module tumblr_phone_ios_optimized
 * @requires module:utility
 */

/**
 * Explores features of the tumblr tab on the phone_ios_optimized
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('tumblr phone_ios_optimized'); 
  /**
