...
/**
 * @module youtube_desktop_optimized
 * @requires module:utility
 */

/**
 * Explores features of the youtube tab on the desktop_optimized
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('youtube desktop'); 
  /**
  ...
  return getDriverFunctions.loadPage('index.desktop.optimized.html')
