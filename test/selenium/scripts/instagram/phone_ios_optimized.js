...
/**
 * @module instagram_phone_ios_optimized
 * @requires module:utility
 */

/**
 * Explores features of the instagram tab on the phone_ios_optimized
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('instagram phone_ios_optimized'); 
  /**
