...
/**
 * @module twitter_phone
 * @requires module:utility
 */

/**
 * Explores features of the twitter tab on the phone
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('twitter phone'); 
  /**
  ...
  return getDriverFunctions.loadPage('index.phone.html')
