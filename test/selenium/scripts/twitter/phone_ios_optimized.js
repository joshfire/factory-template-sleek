...
/**
 * @module twitter_phone_ios_optimized
 * @requires module:utility
 */

/**
 * Explores features of the twitter tab on the phone_ios_optimized
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('twitter phone_ios_optimized'); 
  /**
  ...
  return getDriverFunctions.loadPage('index.phone.ios.optimized.html')
    .then(getDriverFunctions.exploreApp(3))
