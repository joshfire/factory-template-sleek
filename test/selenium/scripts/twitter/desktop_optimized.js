...
/**
 * @module twitter_desktop
 * @requires module:utility
 */

/**
 * Explores features of the twitter tab on the desktop
 *
 * @constructor
...
module.exports = function (driver, getDriverFunctions, conditions) {
  var logger = woodman.getLogger('twitter desktop'); 
  /**
  ...
  return getDriverFunctions.loadPage('index.desktop.html')
